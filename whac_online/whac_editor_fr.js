...
function saveCard(card) {
	...
	$.ajax({ 
			url: "https://api.mlab.com/api/1/databases/whac_fr/collections/models/" + card._id + "/?apiKey=wcadeCXsaFhH5G4__crfJpZBdloyTTAa" ,
		  	type: "PUT",
...
function updateCapacity() {
	...
	$("body").css("cursor", "progress");
	$.ajax({ 
		url: "https://api.mlab.com/api/1/databases/whac_fr/collections/capacities/" + $capa_id + "/?apiKey=wcadeCXsaFhH5G4__crfJpZBdloyTTAa" ,
	  	type: "PUT",
	  	contentType: "application/json",
	  	dataType: "json",
...
function updateSpell() {
	...
	$("body").css("cursor", "progress");
	$.ajax({ 
		url: "https://api.mlab.com/api/1/databases/whac_fr/collections/spells/" + $spell_id + "/?apiKey=wcadeCXsaFhH5G4__crfJpZBdloyTTAa" ,
	  	type: "PUT",
	  	contentType: "application/json",
	  	dataType: "json",
...
function loadModels() {
	$.ajax({ 
			url: "https://api.mlab.com/api/1/databases/whac_fr/collections/models?s={'name':1}&apiKey=wcadeCXsaFhH5G4__crfJpZBdloyTTAa" ,
		  	type: "GET",
		  	contentType: "application/json",
		  	dataType: "json",
		  	success:   function( data, jqXHR, textStatus){
...
function createNewCapacity() {
	...
	$("body").css("cursor", "progress");
	$.ajax({ 
	url: "https://api.mlab.com/api/1/databases/whac_fr/collections/capacities?apiKey=wcadeCXsaFhH5G4__crfJpZBdloyTTAa" ,
		type: "POST",
		contentType: "application/json",
		dataType: "json",
		data: JSON.stringify( {"_title" : $capa_name , "_type" : $capa_type, "__text" : $capa_text }),
...
function createNewSpell() {
	...
	$("body").css("cursor", "progress");
	$.ajax({ 
		url: "https://api.mlab.com/api/1/databases/whac_fr/collections/spells/?apiKey=wcadeCXsaFhH5G4__crfJpZBdloyTTAa" ,
	  	type: "POST",
	  	contentType: "application/json",
	  	dataType: "json",
	  	data: JSON.stringify( { "_name" : $spell_name , "_cost" : $spell_cost, "_rng" : $spell_range, "_pow" : $spell_pow, "_aoe" : $spell_aoe, "_duration" : $spell_duration, "_off" : $spell_off, "__text" : $spell_desc }),
