faction_minions_entries = {
	"groups": [{
		...
		"entries": [{
			...
			"works_for": ["faction_orboros", "faction_everblight", "faction_trollblood", "faction_skorne"],
			"type": "warlock",
			"cost": 5,
			...
			"fa": "C",
			"faction": "faction_minions",
			"works_for": ["faction_orboros", "faction_everblight", "faction_skorne"],
			"type": "warlock",
			"cost": 6,
			"name": "Dr. Arkadius"
		}, {
		...
		"entries": [{
			...
			"type": "warbeast",
			"cost": 5,
			"restricted_to": ["IW08", "IW10", "IW11", "IW05", "IW13", "IW03_minion"],
			"name": "Gun Boar"
		}, {
			"id": "IB02",
			"fa": "U",
			...
			"type": "warbeast",
			"cost": 8,
			"restricted_to": ["IW06", "IW07", "IW09", "IW12", "IW14", "IW04_minion"],
		...
		"entries": [{
			...
			"fa": "2",
			"faction": "faction_minions",
			"works_for": ["faction_orboros", "faction_everblight"],
			"type": "battleengine",
			"cost": 9,
			"name": "Sacral Vault"
		}, {
			...
			"fa": "2",
			"faction": "faction_minions",
			"works_for": ["faction_skorne", "faction_trollblood"],
			"type": "battleengine",
			"cost": 9,
			"name": "Meat Thresher"
		}],
		...
		"entries": [{
			...
			"fa": "C",
			"faction": "faction_minions",
			"works_for": ["faction_orboros", "faction_trollblood", "faction_skorne"],
			"type": "solo",
			"cost": 2,
			"name": "Saxon Orrik"
		}, {
			...
			"fa": "3",
			"faction": "faction_minions",
			"works_for": ["faction_orboros", "faction_skorne"],
			"type": "solo",
			"cost": 2,
			...
			"fa": "3",
			"faction": "faction_minions",
			"works_for": ["faction_orboros", "faction_everblight", "faction_skorne", "faction_trollblood"],
			"type": "solo",
			"cost": 2,
			"name": "Gremlin Swarm"
		}, {
			...
			"fa": "2",
			"faction": "faction_minions",
			"works_for": ["faction_orboros", "faction_skorne", "faction_trollblood"],
			"type": "solo",
			"cost": 3,
			"name": "Efaarit Scouts"
		}, {
...
faction_minions_tiers = {
	"tiers": [{
		...
		"levels": [{
			...
			"mustHave": [],
			"onlyModels": {
				"ids": ["IW06", "IB03", "IB04", "IB05", "IB07", "IB08", "IU01", "IU04", "IU08", "IS09", "IS11", "IW04_minion", "Snapjaw_minion"]
			},
			"level": 1,
			"benefit": "",
			"faAlterations": [{
		...
		"levels": [{
			...
			"mustHave": [],
			"onlyModels": {
				"ids": ["IW07", "IB03", "IB04", "IB05", "IB07", "IB08", "IU01", "IU02", "IU04", "IU08", "IS02", "IS09", "IS11", "IW04_minion", "Snapjaw_minion"]
			},
			"level": 1,
		...
		"levels": [{
			...
			"mustHave": [],
			"onlyModels": {
				"ids": ["IW08", "IB01", "IB02", "IB06", "IB09", "IU02", "IU03", "IU06", "IU07", "IW03_minion", "Brine_minion", "IS10"]
			},
			"level": 1,
			"benefit": "",
			"faAlterations": []
		...
		"levels": [{
			...
			"mustHave": [],
			"onlyModels": {
				"ids": ["IW08", "IB01", "IB02", "IB06", "IB09", "IU02", "IU07", "OB02_minion_arkadius", "IS10"]
			},
			"level": 1,
			...
			"freeModels": [{
				"id": ["IB09"],
				"forEach": ["IB01", "IB02", "IB06"]
			}],
			"costAlterations": [],
			"mustHave": [{
				"inMarshal": false,
				"min": 5,
				"ids": ["IB01", "IB02", "IB06", "IB09", "OB02_minion_arkadius"],
				"inBG": true
			}],
			"onlyModels": {
				"ids": ["IW08", "IB01", "IB02", "IB06", "IB09", "IU02", "IU07", "OB02_minion_arkadius", "IS10"]
		...
		"levels": [{
			...
			"mustHave": [],
			"onlyModels": {
				"ids": ["IW13", "IB01", "IB02", "IB09", "IB06", "IU02", "IU03", "IU06", "IU07", "IW03_minion", "Brine_minion", "IS03_minion", "IS13", "IS14", "IE02"]
			},
			"level": 1,
			"faAlterations": []
		}, {
		...
		"levels": [{
			...
			"mustHave": [],
			"onlyModels": {
				"ids": ["IW14", "IB03", "IB04", "IB05", "IB07", "IB08", "IU01", "IU04", "IU08", "IS09", "IS11", "IS02", "IS08", "IW04_minion", "Snapjaw_minion", "IE02"]
			},
			"level": 1,
			"faAlterations": []
		}, {
		...
		"levels": [{
			...
			"mustHave": [],
			"onlyModels": {
				"ids": ["IW05", "IB01", "IB02", "IB09", "IB06", "IU02", "IU03", "IU06", "IU07", "IW03_minion", "Brine_minion", "IS10"]
			},
			"level": 1,
		...
		"levels": [{
			...
			"mustHave": [],
			"onlyModels": {
				"ids": ["IW09", "IB03", "IB04", "IB05", "IB07", "IB08", "IU01", "IU04", "IS11", "IS02", "IW04_minion", "Snapjaw_minion", "IU08"]
			},
			"level": 1,
			"benefit": "",
			"faAlterations": [{
		...
		"levels": [{
			...
			"mustHave": [],
			"onlyModels": {
				"ids": ["IW11", "IB01", "IB02", "IB06", "IB07_midas", "IB09", "IU02", "IU03", "IU06", "IU07", "IW03_minion", "Brine_minion", "IS10"]
			},
			"level": 1,
			...
			"mustHave": [{
				"inMarshal": false,
				"min": 4,
				"ids": ["IB01", "IB02", "IB06", "IB09", "IB07_midas"],
				"inBG": true
			}],
			"onlyModels": {
				"ids": ["IW11", "IB01", "IB02", "IB06", "IB07_midas", "IB09", "IU02", "IU03", "IU06", "IU07", "IW03_minion", "Brine_minion", "IS10"]
		...
		"levels": [{
			...
			"mustHave": [],
			"onlyModels": {
				"ids": ["IW12", "IB03", "IB04", "IB05", "IB07", "IB08", "IU01", "IU08", "IS11", "IS07", "IS09", "IS08"]
			},
			"level": 1,
			"benefit": "",
			"faAlterations": [{
		...
		"levels": [{
			...
			"mustHave": [],
			"onlyModels": {
				"ids": ["IW10", "IB01", "IB02", "IB06", "IB09", "IU02", "IU03", "IU06", "IU07", "IW03_minion", "Brine_minion", "IS10"]
			},
			"level": 1,
		...
		"levels": [{
			...
			"mustHave": [],
			"onlyModels": {
				"ids": ["IW06", "IW07", "IW09", "IW12", "IW14", "IB03", "IB04", "IB05", "IB07", "IB08", "MJ04_minion", "MJ12_minion", "MJ09_minion", "MJ13_minion", "MJ10_minion", "MJ11_minion", "MJ17_minion", "MJ16_minion", "MJ02_minion", "MJ03_minion", "IE02", "IU01", "IU04", "IU05", "IU08", "IU09", "IS02", "IS05_minion", "IS07", "IS08", "IS09", "IS11", "IW04_minion", "Snapjaw_minion", "MS26_minion", "MS30_minion"]
			},
			"level": 1,
		...
		"levels": [{
			...
			"mustHave": [],
			"onlyModels": {
				"ids": ["IW05", "IW08", "IW10", "IW11", "IW13", "IB01", "IB02", "IB06", "IB09", "MJ04_minion", "MJ12_minion", "MJ09_minion", "MJ13_minion", "MJ10_minion", "MJ11_minion", "MJ17_minion", "MJ16_minion", "MJ02_minion", "MJ03_minion", "IE01", "IU02", "IU03", "IU06", "IU07", "IS01_minion", "IS03_minion", "IS05_minion", "IS06_minion", "IS10", "IW03_minion", "Brine_minion", "MS26_minion", "IS13", "IS14"]
			},
			"level": 1,
